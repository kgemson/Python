...
# Add labels
l0=Label(window,padx=5)
l0.grid(row=0,column=0,rowspan=8)
...
l5.grid(row=8,column=1,columnspan=3)

lx=Label(window,padx=5,border=1,borderwidth=2)
lx.grid(row=0,column=5,rowspan=8)
...
list1.grid(row=2,column=1,columnspan=2,rowspan=6)
